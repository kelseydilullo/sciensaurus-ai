...
// Inner component to contain the logic using searchParams
function DemoPageContent() {
  ...
  // Return the main page structure
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {/* Pass urlToAnalyze state to the wrapper */}
...
// Main export renders the content within Suspense
